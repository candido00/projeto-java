...
public class FormPrincipal extends javax.swing.JFrame {
    ...
    public FormPrincipal() {
        initComponents();
        textClientePesq.setDocument(new SomenteLetras());
        textFuncionarioPesq.setDocument(new SomenteLetras());
    ...
    public void listarFuncionarios() {
        try {
            ...
            Funcionario filtroF = new Funcionario();
            filtroF.setNome(textFuncionarioPesq.getText());
            funcionarios = df.listarF(filtroF);
            DefaultTableModel modelo = new DefaultTableModel() {
            ...
            for (int x = 0; x < funcionarios.size(); x++) {
                modelo.addRow(new String[]{funcionarios.get(x).getCpf(), funcionarios.get(x).getNome(), funcionarios.get(x).getEmail()});
            }
    ...
    private void initComponents() {
        ...
        textClientePesq.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                textClientePesqKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(textServiçoPesq, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        jButtonOrcamentoEdi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonOrcamentoEdiActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(42, 42, 42)
                        .addComponent(jButtonOrcamentoEnv, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonFuncionarioDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFuncionarioDelActionPerformed
        ...
        try {
            if (listviewFuncionario.getSelectedRow() >= 0) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Favor selecionar uma funcionario!");
            }
    ...
    private void jButtonFuncionarioEdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFuncionarioEdiActionPerformed
        ...
        if (listviewFuncionario.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(this, "Favor selecionar um funcionario.");

        } else {
            Funcionario fun = funcionarios.get(listviewFuncionario.getSelectedRow());
            //JOptionPane.showMessageDialog(this, cliente.getCep());
            FormEditarFuncionario form = new FormEditarFuncionario(fun);
    ...
    private void jButtonClienteEdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonClienteEdiActionPerformed
        // TODO add your handling code here:
        if (listviewCliente.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(this, "Favor selecionar um cliente");
    ...
    private void jButtonServiçoCadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonServiçoCadActionPerformed
        // TODO add your handling code here:
        FormCadastroServico form = new FormCadastroServico();
        form.setVisible(true);
    ...
    private void jButtonOrcamentoEdiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOrcamentoEdiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonOrcamentoEdiActionPerformed

    private void textClientePesqKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textClientePesqKeyTyped
        // TODO add your handling code here:
 ...
 /*if (textClientePesq.getText().trim().equals("")==true) {
            jButtonClientePesq.setEnabled(false);
            
        }else{
            jButtonClientePesq.setEnabled(true);
        }*/

    }//GEN-LAST:event_textClientePesqKeyTyped
